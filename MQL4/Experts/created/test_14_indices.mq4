...
//tradecondition[avg1] = AVG_check1(15, 0);
   ...
   if(((tradecondition[ao1] == buy) && (tradecondition[time_gap] == 1) && (tradecondition[rsi3] == buy)) ||
      ((tradecondition[rsi2] == buy) && (tradecondition[time_gap] == 1) &&
   ...
   if(((tradecondition[ao1] == sell) && (tradecondition[time_gap] == 1)  && (tradecondition[rsi3] == sell)) ||
      ((tradecondition[rsi2] == sell) && (tradecondition[time_gap] == 1) &&
