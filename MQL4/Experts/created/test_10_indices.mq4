...
///////////////////////real/////////////////////////////////////
   ...
   tradecondition[rsi2] = RSI_check1(rsi2, 30, 40, 65, 1.5);  //return if in buy or sell region
   ...
   if(
     ...
     {
      double size = InpOrderSize + 0.005 * buycount;
   ...
   if(
     ...
     {
      double size = InpOrderSize + 0.005 * sellcount;
