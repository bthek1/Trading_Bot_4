...
enum status {rsi1, rsi2, rsi3, stoch1, stoch2, moch1, moch2, avg1, margin1, time_gap};
...
///////////////////////real/////////////////////////////////////
   ...
   tradecondition[rsi1] = RSI_check2(rsi1, 15, 20, 70, tradecondition[rsi1]);
...
//tradeallow = trade_margin_calc();
   ...
   if((tradecondition[rsi2] == buy) && (tradecondition[time_gap] == 1) &&
   ...
   if((tradecondition[rsi2] == sell) && (tradecondition[time_gap] == 1) &&
