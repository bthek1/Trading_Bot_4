...
input double               InpOrderSizeInc      =  0.00;       //Order size increase with no. of order
...
//Alert(Close[0]);
   ...
   CalculateCurrentOrdersSize(0.01, 0.0);
///////////////////////real/////////////////////////////////////
   ...
   if((tradecondition[time_gap] == 1))
     {
      ...
      tradecondition[ac1] = AC_check1(0, 0);
     

      if((tradecondition[ac1] == buy))
        {
         double size = buysize;
         ticket = buy_trade(size, 0);
         CalculateCurrentOrders(); //update buycount and sellcount
